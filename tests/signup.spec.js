...
test('TC_001 sign up functionality', async ({ page }) => {
  test.setTimeout(120000)
   ...
   await page.locator('[id="input-firstname"]').fill('Fathi')
   await page.locator('[id="input-lastname"]').fill('Musilia')
   await page.locator('[id="input-email"]').fill('nosfathy_049@yahoo.com')
